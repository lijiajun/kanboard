...
return array(
    ...
    '%s moved the task %s to the position #%d in the column "%s"' => '%s 将任务 %s 移动到了第#%d个位置("%s"状态)',
    ...
    'Task' => '任务',
    'Percentage' => '百分比',
    'Percentage of complete' => '完成百分比',
    'Percentage of scores' => '复杂度总量百分比',
    'Number of scores' => '总复杂度',
    ...
    'User tasks repartition' => '用户任务数分析',
    'User scores repartition' => '用户复杂度分析',
    ...
    'Exports' => '导出',
    'This export contains the number of tasks per column grouped per day.' => '此导出包含每栏目的任务数，按天分组',
    ...
    'Burndown chart' => '燃尽图',
    'Burndown chart(Tasks)' => '任务数燃尽图',
    'Burndown chart(Score)' => '复杂度燃尽图',
    ...
    'When task is moved from first column' => '当任务从第一栏目任务栏移走时',
    'When task is moved to last column' => '当任务移动到最后一栏目任务栏时',
    'Year(s)' => '年',
    ...
    'There is no swimlane now' => '当前没有泳道',
    'New swimlane: %s' => '新泳道：%s',
    'There is no column now' => '当前没有栏目',
    'New column: %s' => '新栏目：%s',
    'New color: %s' => '新颜色：%s',
    'New complexity: %d points' => '新的复杂度：%d点',
    'New complexity: 1/2 points' => '新的复杂度：½点',
    ...
    'Only for tasks created by me and assigned to me' => '所有我创建的和指派给我的任务',
    // '%%Y-%%m-%%d' => '',
    ...
    'Average Lead and Cycle time' => '平均交货和研发周期',
    'Average lead time: ' => '平均交货周期',
    'Average cycle time: ' => '平均研发周期',
    'Cycle Time' => '研发周期',
    'Lead Time' => '交货周期',
    'This chart show the average lead and cycle time for the last %d tasks over the time.' => '这个图标显示了最新%d条任务的平均交货和研发周期。',
    'Average time into each column' => '每栏平均时间',
    'Lead and cycle time' => '交货和研发周期',
    'Lead time: ' => '交货周期：',
    'Cycle time: ' => '研发周期：',
    'Time spent into each column' => '每一栏花费的时间',
    'The lead time is the duration between the task creation and the completion.' => '交货周期是任务从创建到完成的时间。',
    'The cycle time is the duration between the start date and the completion.' => '研发周期是任务从开始处理到完成的时间。',
    ...
    'If you check the box "Disallow login form", credentials entered in the login form will be ignored.' => '如果选中“禁止登陆”，登陆表单内的验证信息将被忽略。',
    ...
    'People who are project ext members' => '项目外援',
    ...
    '%d task(s) in the column "%s" and the swimlane "%s" will be closed.' => '将有%d条任务被关闭，在"%s" 状态，"%s"泳道中。',
    ...
    'Projects where "%s" is ext member' => '"%s"　参与的临时项目',
    ...
    'Creator Name' => '创建人名称',
    'Time spent and estimated' => '时间花费/预估',
    'Move position' => '移动位置',
    ...
    'API User Access' => 'API访问',
    'Preview' => '预览',
    'Write' => '写入',
    'Write your text in Markdown' => '用markdown格式写入文本',
    'New External Task: %s' => '新的外部任务：%s',
    'No personal API access token registered.' => '没有注册API访问令牌。',
    'Your personal API access token is "%s"' => '你的API访问令牌是 “%s”',
    ...
    'Another category with the same name exists in this project' => '该项目中存在相同名字的分类',
    'Comment sent by email successfully.' => '评论通过电子邮件发送成功。',
    // 'Sent by email to [%s](mailto:%s) (%s)' => '',
    'Unable to read uploaded file.' => '无法读取上传的文件。',
    'Database uploaded successfully.' => '数据库上传成功。',
    'Task sent by email successfully.' => '任务通过电子邮件发送成功。',
    'There is no category in this project.' => '这个项目中没有分类。',
    'Send by email' => '通过电子邮件发送',
    'Create and send a comment by email' => '通过邮件创建并发送一个评论',
    'Subject' => '主题',
    'Upload the database' => '上传数据库',
    'You could upload the previously downloaded Sqlite database (Gzip format).' => '你可以上传以前下载的Sqlite数据库(Gzip格式)。',
    'Database file' => '数据库文件',
    'Upload' => '上传',
    'Your project must have at least one active swimlane.' => '你的项目必须至少有一个活动的泳道。',
    'Project: %s' => '项目：%s',
    'Automatic action not found: "%s"' => '没有找到自动动作："%s"',
    'There is no project.' => '没有项目。',
    'Assign automatically a color when due date is expired' => '到期自动指定颜色',
    'Total score in this column across all swimlanes' => '此任务栏下的总复杂度(跨泳道)',
    // 'HRK - Kuna' => '',
    // 'ARS - Argentine Peso' => '',
    // 'COP - Colombian Peso' => '',
    // 'External ID' => '',
    ...
    'Notifications are activated' => '通知启用',
    'Notifications are disabled' => '通知关闭',
    'User disabled' => '用户已禁用',
    '%d notifications' => '%d条通知',
    '%d notification' => '%d条通知',
    'There is no external integration installed.' => '没有外部集成安装。',
    'You are not allowed to update tasks assigned to someone else.' => '你不能更新分派给别人的任务。',
    'You are not allowed to change the assignee.' => '你不能变更指派人。',
    // 'Task suppression is not permitted' => '',
    'Changing assignee is not permitted' => '不允许更改指派人',
    'Update only assigned tasks is permitted' => '只允许更新配指派的任务',
    ...
    'This task was sent by email to "%s" with subject "%s".' => '这个任务通过邮件发送给"%s"，主题是"%s"。',
    'Predefined Email Subjects' => '预定义电子邮件主题',
